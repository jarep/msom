...
<div id="intervalValue">
    ...
    <input style="width: 100px" class="form-control"  onkeypress="return isNumber(event)"  id="intervalValueInput"type="number"  onKeyUp="setIntervalValue()" onChange="setIntervalValue()" value="1"/>
</div>
